...
import { CreateStaffManagementForm } from "../staff-add";
  ...
  return (
    <>
      ...
      <ModalForm
        ...
        title={isUpdate ? "Update Admin" : "Add Admin"}
        onCloseModal={onMemberModalClose}
        resetButtonText={"Cancel"}
        isLoading={isLoading}
        submitButtonText={isUpdate ? "Update Admin" : "Add Admin"}
